...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['upload'])) {
    ...
    if (move_uploaded_file($file_tmp, $upload_dir . basename($file_name))) {
        ...
        $query = "INSERT INTO acuerdos_academicos_documentos (user_id, file_name, file_type, comment) VALUES (?, ?, ?, ?)";
        ...
        header("Location: acuerdos_academia.php");
        exit();
    } else {
...
if (isset($_POST['delete'])) {
    ...
    $query = "SELECT file_name FROM acuerdos_academicos_documentos WHERE id = ?";
    $stmt = $conn->prepare($query);
    ...
    if ($result->num_rows > 0) {
        ...
        $query = "DELETE FROM acuerdos_academicos_documentos WHERE id = ?";
        $stmt = $conn->prepare($query);
        $stmt->bind_param("i", $file_id);
        $stmt->execute();
        $stmt->close();
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="../dashboard.php">Acuerdos Académicos</a>
    ...
    <div class="container main-content mt-4">
        <h1 class="mb-4">Gestión de Documentos de Acuerdos Académicos</h1>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="acuerdos_academia.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                        ...
                        <?php if ($result->num_rows > 0): ?>
                            <?php while ($row = $result->fetch_assoc()): ?>
                                <div class="file-item">
                                    ...
                                    <form action="acuerdos_academia.php" method="POST" class="d-inline">
