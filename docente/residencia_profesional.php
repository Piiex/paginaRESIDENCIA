...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['upload'])) {
    ...
    if (move_uploaded_file($file_tmp, $upload_dir . basename($file_name))) {
        ...
        $query = "INSERT INTO residencia_documentos (user_id, file_name, file_type, comment) VALUES (?, ?, ?, ?)";
        ...
        header("Location: residencia_profesional.php");
        exit();
    } else {
...
if (isset($_POST['delete'])) {
    ...
    $query = "SELECT file_name FROM residencia_documentos WHERE id = ?";
    $stmt = $conn->prepare($query);
    ...
    if ($result->num_rows > 0) {
        ...
        $query = "DELETE FROM residencia_documentos WHERE id = ?";
        $stmt = $conn->prepare($query);
        $stmt->bind_param("i", $file_id);
        $stmt->execute();
        $stmt->close();
...
$query = "SELECT * FROM residencia_documentos WHERE user_id = ?";
$stmt = $conn->prepare($query);
...
<head>
    ...
    <title>Documentos de Residencia Profesional</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="../dashboard.php">Residencia Profesional</a>
    ...
    <div class="container main-content mt-4">
        <h1 class="mb-4">Gestión de Documentos de Residencia Profesional</h1>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="residencia_profesional.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                        ...
                        <?php if ($result->num_rows > 0): ?>
                            <?php while ($row = $result->fetch_assoc()): ?>
                                <div class="file-item">
                                    ...
                                    <form action="residencia_profesional.php" method="POST" class="d-inline">
